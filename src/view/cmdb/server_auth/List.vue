<template>
  <div>
    <Card>
      ...
      >
      <div slot="new_btn" class="search-col" style="width:250px">
        <Button type="info" class="search-btn"  @click="handleAdd">添加规则</Button>
      </div>
      </tables>
      </br>
    ...
    <Add :dialog="dialog" :formData="formData" :systemUser="systemUser" @e-update="getData" @e-close="closeModal"></Add>
...
import { getTableData, getSystemUser, loginGW, delRule } from '@/api/cmdb/server_auth.js'
import Add from './Add'
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            return h('div', [h(Tag, {props: {color: 'warning'}}, user_list.length)])
          }
        },
        {
          title: '主机',
          ...
          align: 'center',
          render: (h, params) => {
            return h('div', [h(Tag, {props: {color: 'primary'}}, params.row.server.length)])
          }
        },
        {
          title: '主机组',
          ...
          align: 'center',
          render: (h, params) => {
            return h('div', [h(Tag, {props: {color: 'primary'}}, params.row.servergroup.length)])
          }
        },
        {
          title: '操作',
